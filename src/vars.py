...
\*нажимая на кнопку ты  выражаешь согласие с [политикой конфиденциальности](https://gband.app/politika_konfidencialnosti)
"""
...
SIGNUP_FINISHED_REQUIRED_BUTTON = """Дать инфо алгоритму b0 ✍️"""
