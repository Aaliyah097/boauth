...
Способны ли алгоритмы и AI оценить крепость дружбы и отношений? 🦾

Мы в это не верили, пока не придумали лучший алгоритм совместимости b0. Для этого ему нужно знать твои ценности, дату рождения и пол. 🔗
